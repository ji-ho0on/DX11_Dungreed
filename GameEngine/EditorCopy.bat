...
xcopy .\AR41Editor\Include\Animation2D\*.* .\Client2D\Include\Animation2D\ /d /s /y /exclude:EditorExclude.txt
xcopy .\AR41Editor\Include\TransferInfo\*.* .\Client2D\Include\TransferInfo\ /d /s /y /exclude:EditorExclude.txt
