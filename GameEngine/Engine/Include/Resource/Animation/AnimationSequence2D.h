...
public:
    ...
    bool InitArray(const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName = TEXTURE_PATH);
    bool InitArrayFullPath(const std::string& Name, const std::vector<const TCHAR*>& vecFullPath);
    ...
    void EditFrame(int Index, const Vector2& Start, const Vector2& End);
    void ClearFrame();
