...
public:
    ...
    EPixelCollision_Type GetPixelColorCollisionType()   const
    {
        return m_Info->PixelColorCollisionType;
    }

    EPixelCollision_Type GetPixelAlphaCollisionType()   const
    {
        return m_Info->PixelAlphaCollisionType;
    }

    unsigned char* GetPixelTypeColor()  const
    {
        return m_Info->TypeColor;
    }
