...
private:
	...
	static float					m_MinY;			// 2D 게임에서 Y값을 Z값으로 변환하기 위한 변수
	static float					m_MaxY;			// 2D 게임에서 Y값을 Z값으로 변환하기 위한 변수
	float							m_2DZ;			// 2D 게임에서 Z값을 처리하기 위한 변수
