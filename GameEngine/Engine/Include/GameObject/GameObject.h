...
public:
	// 여기에 재정의하는 이유는 이 오브젝트가 제거될때 가지고 있는 모든 컴포넌트들도 제거를 해주기 위해서이다.
...
public:
	...
	void DeleteObjectComponent(CObjectComponent* Component)
	{
...
public:
	...
	T* CreateComponent(const std::string& Name)
	{
		...
		if (Component->GetComponentType() == EComponentType::Object)
		{
