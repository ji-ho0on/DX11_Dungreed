...
CUIText::CUIText() :
    ...
    m_ShadowOpacity(1.f),
    m_AlignH(EText_Align_H::Left),
    m_AlignV(EText_Align_V::Top),
    m_ShadowOffset(1.f, 1.f)
{
    m_Color.w = m_Opacity;
    m_ShadowColor.w = m_ShadowOpacity;
...
void CUIText::SetAlignH(EText_Align_H Align)
{
    m_AlignH = Align;
...
void CUIText::SetAlignV(EText_Align_V Align)
{
    m_AlignV = Align;
...
void CUIText::Save(FILE* File)
{
    ...
    fwrite(&m_AlignH, sizeof(EText_Align_H), 1, File);
    fwrite(&m_AlignV, sizeof(EText_Align_V), 1, File);
}
...
void CUIText::Load(FILE* File)
{
    ...
    fread(&m_AlignH, sizeof(EText_Align_H), 1, File);
    fread(&m_AlignV, sizeof(EText_Align_V), 1, File);
