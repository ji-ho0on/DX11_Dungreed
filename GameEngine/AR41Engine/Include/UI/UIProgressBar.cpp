    ...
    CUIWidget(ProgressBar)
{
    ...
    m_BarOpacity = ProgressBar.m_BarOpacity;
...
bool CUIProgressBar::SetTextureArray(EProgressBarTextureType Type, const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
    if (m_Scene)
    {
...
bool CUIProgressBar::SetTextureArrayFullPath(EProgressBarTextureType Type, const std::string& Name, const std::vector<const TCHAR*>& vecFullPath)
{
    if (m_Scene)
    {
...
void CUIProgressBar::SetBarDir(EProgressBarDir Dir)
{
    m_BarDir = Dir;
}

void CUIProgressBar::SetBarOpacity(float Opacity)
{
...
void CUIProgressBar::Render()
{
    ...
    m_CBuffer->SetOpacity(m_BarOpacity);
...
void CUIProgressBar::Save(FILE* File)
{
    ...
    fwrite(&m_BarOpacity, sizeof(float), 1, File);
}
...
void CUIProgressBar::Load(FILE* File)
{
    ...
    fread(&m_BarOpacity, sizeof(float), 1, File);
}
