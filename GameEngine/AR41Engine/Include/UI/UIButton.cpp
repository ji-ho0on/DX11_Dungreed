    ...
    m_MouseHovered(false)
{
    ...
    SetImageTint(EButtonState::Normal, 255, 255, 255, 255);
    SetImageTint(EButtonState::Hovered, 255, 255, 255, 255);
    SetImageTint(EButtonState::Click, 255, 255, 255, 255);
...
bool CUIButton::SetTexture(EButtonState State, const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
    if (m_Scene)
    {
...
bool CUIButton::SetTextureArray(EButtonState State, const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
    if (m_Scene)
    {
...
bool CUIButton::SetTextureArrayFullPath(EButtonState State, const std::string& Name, const std::vector<const TCHAR*>& vecFullPath)
{
    if (m_Scene)
    {
...
void CUIButton::Update(float DeltaTime)
{
    ...
    if (m_State != EButtonState::Disable)
    {
        ...
        if (MouseHovered)
        {
            ...
            {
                if (m_Sound[(int)EButtonEventState::Click] && m_Scene->GetViewport()->GetCollisionWidget() == (CUIWidget*)this)
                    m_Sound[(int)EButtonEventState::Click]->Play();

                if (m_ClickCallback[(int)EButtonEventState::Click] && m_Scene->GetViewport()->GetCollisionWidget() == (CUIWidget*)this)
            ...
            else
            {
                ...
                {
                    if (m_Sound[(int)EButtonEventState::Hovered] && m_Scene->GetViewport()->GetCollisionWidget() == (CUIWidget*)this)
                        m_Sound[(int)EButtonEventState::Hovered]->Play();
                }

                if (m_ClickCallback[(int)EButtonEventState::Hovered] && m_Scene->GetViewport()->GetCollisionWidget() == (CUIWidget*)this)
