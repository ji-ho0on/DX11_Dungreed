...
protected:
    ...
    EText_Align_H           m_AlignH;
    EText_Align_V           m_AlignV;
...
public:
    ...
    void SetAlignH(EText_Align_H Align);
    void SetAlignV(EText_Align_V Align);
