...
void CRenderManager::DeleteRenderList(CSceneComponent* Component)
{
	auto	iter = m_RenderLayerList.begin();
	auto	iterEnd = m_RenderLayerList.end();
...
bool CRenderManager::Init()
{
	...
	CreateLayer("Back3", 3);
	CreateLayer("NPC", 4);
	CreateLayer("Monster", 5);
	CreateLayer("Weapon", 6);
	CreateLayer("Default", 7);
	CreateLayer("Effect", 8);
	CreateLayer("Front", 9);
	...
	SetLayerAlphaBlend("Back1");
	SetLayerAlphaBlend("Back2");
	SetLayerAlphaBlend("Back3");
	SetLayerAlphaBlend("NPC");
	SetLayerAlphaBlend("Monster");
	SetLayerAlphaBlend("Weapon");
	SetLayerAlphaBlend("Default");
	SetLayerAlphaBlend("Effect");
	SetLayerAlphaBlend("Front");
...
bool CRenderManager::CreateDepthStencil(const std::string& Name, bool DepthEnable, D3D11_DEPTH_WRITE_MASK DepthWriteMask, D3D11_COMPARISON_FUNC DepthFunc,
	bool StencilEnable, UINT8 StencilReadMask, UINT8 StencilWriteMask, D3D11_DEPTH_STENCILOP_DESC FrontFace, D3D11_DEPTH_STENCILOP_DESC BackFace)
{
