...
bool CRenderStateManager::CreateDepthStencil(const std::string& Name, bool DepthEnable,	D3D11_DEPTH_WRITE_MASK DepthWriteMask, D3D11_COMPARISON_FUNC DepthFunc,
	bool StencilEnable, UINT8 StencilReadMask, UINT8 StencilWriteMask, D3D11_DEPTH_STENCILOP_DESC FrontFace, D3D11_DEPTH_STENCILOP_DESC BackFace)
{
	...
	if (!State->CreateDepthStencil(DepthEnable, DepthWriteMask, DepthFunc, StencilEnable, StencilReadMask,
