...
public:	// ===================== Mesh =========================
	bool CreateMesh(EMeshType Type, const std::string& Name,	void* VtxData, int Size, int Count,
...
public:	// ===================== Texture =========================
	...
	bool LoadTextureArray(const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName = TEXTURE_PATH);
...
public:	// ===================== Animation =========================
	...
	bool AddAnimationSequence2DFrameAll(const std::string& Name, int Count, float StartX, float StartY, float EndX, float EndY);
...
public:	// ============================ Font ================================
	...
	bool LoadFont(const std::string& Name, const TCHAR* FontName, int Weight, float FontSize, const TCHAR* LocalName, int Stretch = 5);
