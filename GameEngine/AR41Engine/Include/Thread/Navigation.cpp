...
{
	// 한칸씩 위로 올라가며 오른쪽이 막혀있고 오른쪽 위가 뚫려있을 경우나 왼쪽이 막혀있고 왼쪽 위가 뚫려있으면 해당 노드는 코너가 된다.
...
{
	// 한칸씩 아래로 내려가며 오른쪽이 막혀있고 오른쪽 아래가 뚫려있을 경우나 왼쪽이 막혀있고 왼쪽 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexY = Node->IndexY;
...
{
	// 한칸씩 왼쪽으로 가며 위가 막혀있고 왼쪽 위가 뚫려있을 경우나 아래가 막혀있고 왼쪽 아래가 뚫려있으면 해당 노드는 코너가 된다.
...
{
	// 한칸씩 오른쪽으로 가며 위가 막혀있고 오른쪽 위가 뚫려있을 경우나 아래가 막혀있고 오른쪽 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
...
{
	// 한칸씩 왼쪽 위로 가며 오른쪽이 막혀있고 오른쪽 위가 뚫려있을 경우나 아래가 막혀있고 왼쪽 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 왼쪽 위로 진행이 되므로 왼쪽, 그리고 위쪽으로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
...
{
	// 한칸씩 오른쪽 위로 가며 왼쪽이 막혀있고 왼쪽 위가 뚫려있을 경우나 아래가 막혀있고 오른쪽 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 오른쪽 위로 진행이 되므로 오른쪽, 그리고 위쪽으로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
		NavNode* Find = GetCornerRectTop(CornerNode, EndNode);
...
{
	// 한칸씩 왼쪽 아래로 가며 오른쪽이 막혀있고 오른쪽 아래가 뚫려있을 경우나 위가 막혀있고 왼쪽 위가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 왼쪽 아래로 진행이 되므로 왼쪽, 그리고 아래쪽으로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
...
{
	// 한칸씩 오른쪽 아래로 가며 왼쪽이 막혀있고 왼쪽 아래가 뚫려있을 경우나 위가 막혀있고 오른쪽 위가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 오른쪽 아래로 진행이 되므로 오른쪽, 그리고 아래쪽으로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
		NavNode* Find = GetCornerRectBottom(CornerNode, EndNode);
...
{
	// 한칸씩 위로 가며 왼쪽 아래가 막혀있고 왼쪽이 뚫려있을 경우나 오른쪽 아래가 막혀있고 오른쪽이 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 위로 진행이 되므로 오른쪽 위, 그리고 왼쪽 위로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
...
{
	// 한칸씩 아래로 가며 왼쪽 위가 막혀있고 왼쪽이 뚫려있을 경우나 오른쪽 위가 막혀있고 오른쪽이 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 아래로 진행이 되므로 오른쪽 아래, 그리고 왼쪽 아래로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
...
{
	// 한칸씩 왼쪽으로 가며 오른쪽 위가 막혀있고 위가 뚫려있을 경우나 오른쪽 아래가 막혀있고 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 왼쪽으로 진행이 되므로 왼쪽 위, 그리고 왼쪽 아래로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
...
{
	// 한칸씩 오른쪽으로 가며 왼쪽 위가 막혀있고 위가 뚫려있을 경우나 왼쪽 아래가 막혀있고 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
	...
	while (true)
	{
		...
		// 대각선 코너가 아니라면 오른쪽으로 진행이 되므로 오른쪽 위, 그리고 오른쪽 아래로 코너가 있는지를 판단하여 코너가 있다면 현재 노드를 코너드로 판단하도록 한다.
		NavNode* Find = GetCornerIsometricRT(CornerNode, EndNode);
...
{
	// 한칸씩 왼쪽 위로 올라가며 오른쪽 위가 막혀있고 위가 뚫려있을 경우나 왼쪽 아래가 막혀있고 왼쪽이 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
...
{
	// 한칸씩 오른쪽 위로 올라가며 왼쪽 위가 막혀있고 위가 뚫려있을 경우나 오른쪽 아래가 막혀있고 오른쪽이 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
...
{
	// 한칸씩 왼쪽 아래로 내려가며 왼쪽 위가 막혀있고 왼쪽이 뚫려있을 경우나 오른쪽 아래가 막혀있고 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
...
{
	// 한칸씩 오른쪽 아래로 내려가며 오른쪽 위가 막혀있고 오른쪽이 뚫려있을 경우나 왼쪽 아래가 막혀있고 아래가 뚫려있으면 해당 노드는 코너가 된다.
	int	IndexX = Node->IndexX;
	int	IndexY = Node->IndexY;
