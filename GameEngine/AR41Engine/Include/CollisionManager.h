...
public:
	...
	void GetAllProfileName(std::vector<std::string>& vecProfileName);
...
public:
	...
	bool CollisionLine2DToLine2D(Vector2& HitPoint, class CColliderLine2D* Src, class CColliderLine2D* Dest);
	...
	bool CollisionPointToLine2D(Vector2& HitPoint, const Vector2& Src, class CColliderLine2D* Dest);

	bool CollisionBox2DToLine2D(Vector2& HitPoint, class CColliderBox2D* Src, class CColliderLine2D* Dest);
	bool CollisionSphere2DToLine2D(Vector2& HitPoint, class CColliderSphere2D* Src, class CColliderLine2D* Dest);
	bool CollisionOBB2DToLine2D(Vector2& HitPoint, class CColliderOBB2D* Src, class CColliderLine2D* Dest);
	bool CollisionPixelToLine2D(Vector2& HitPoint, class CColliderPixel* Src, class CColliderLine2D* Dest);
...
public:
	...
	bool CollisionLine2DToLine2D(Vector2& HitPoint, const Line2DInfo& Src, const Line2DInfo& Dest);
	...
	bool CollisionPointToLine2D(Vector2& HitPoint, const Vector2& Src, const Line2DInfo& Dest);

	bool CollisionBox2DToLine2D(Vector2& HitPoint, const Box2DInfo& Src, const Line2DInfo& Dest);
	bool CollisionSphere2DToLine2D(Vector2& HitPoint, const Sphere2DInfo& Src, const Line2DInfo& Dest);
	bool CollisionOBB2DToLine2D(Vector2& HitPoint, const OBB2DInfo& Src, const Line2DInfo& Dest);
	bool CollisionPixelToLine2D(Vector2& HitPoint, const PixelInfo& Src, const Line2DInfo& Dest);
