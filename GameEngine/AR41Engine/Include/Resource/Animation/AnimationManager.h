...
private:
	...
	std::unordered_map<std::string, CSharedPtr<CAnimationSequence2D>>	m_mapGlobalSequence2D;
...
public:
	...
	bool CreateAnimationSequence2D(const std::string& Name, const std::string& TextureName, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName = TEXTURE_PATH);
