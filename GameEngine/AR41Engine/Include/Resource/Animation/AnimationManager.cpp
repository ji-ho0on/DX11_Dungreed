...
bool CAnimationManager::CreateAnimationSequence2D(const std::string& Name, CTexture* Texture)
{
	...
	m_mapGlobalSequence2D.insert(std::make_pair(Name, Sequence));
...
bool CAnimationManager::CreateAnimationSequence2DFullPath(const std::string& Name, const std::string& TextureName, const TCHAR* FullPath)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::CreateAnimationSequence2D(const std::string& Name, const std::string& TextureName, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::CreateAnimationSequence2DFullPath(const std::string& Name, const std::string& TextureName, const std::vector<const TCHAR*>& vecFullPath)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::AddAnimationSequence2DFrame(const std::string& Name, const Vector2& Start, const Vector2& End)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::AddAnimationSequence2DFrame(const std::string& Name, float StartX, float StartY, float EndX, float EndY)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::AddAnimationSequence2DFrameAll(const std::string& Name, int Count, const Vector2& Start, const Vector2& End)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
...
bool CAnimationManager::AddAnimationSequence2DFrameAll(const std::string& Name, int Count, float StartX, float StartY, float EndX, float EndY)
{
	CAnimationSequence2D* Sequence = FindAnimationSequence2D(Name);
