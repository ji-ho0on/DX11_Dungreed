...
bool CAnimationSequence2D::Init(const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
	if (m_Scene)
	{
...
bool CAnimationSequence2D::InitArray(const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
	if (m_Scene)
	{
...
bool CAnimationSequence2D::InitArrayFullPath(const std::string& Name, const std::vector<const TCHAR*>& vecFullPath)
{
	if (m_Scene)
	{
...
void CAnimationSequence2D::EditFrame(int Index, const Vector2& Start, const Vector2& End)
{
	if (Index < 0 || Index >(int)m_vecFrameData.size())
		return;
