...
bool CFontManager::Init()
{
    ...
    CreateFontCollection("Default", TEXT("AaCassiopeia.ttf"));
    CreateFontCollection("NumberFont", TEXT("alagard.ttf"));

    LoadFont("Default", GetFontFaceName("Default"), 300, 25.f, TEXT("ko"));
    LoadFont("NumberFont", GetFontFaceName("NumberFont"), 300, 25.f, TEXT("ko"));
