...
void CMaterial::AddTexture(int Register, int ShaderBufferType, const std::string& Name, const TCHAR* FileName, const std::string& PathName)
{
	MaterialTextureInfo* Info = new MaterialTextureInfo;
...
void CMaterial::AddTexture(int Register, int ShaderBufferType, const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
	MaterialTextureInfo* Info = new MaterialTextureInfo;
...
void CMaterial::AddTextureFullPath(int Register, int ShaderBufferType, const std::string& Name,	const std::vector<const TCHAR*>& vecFullPath)
{
	MaterialTextureInfo* Info = new MaterialTextureInfo;
...
void CMaterial::SetTexture(int Index, int Register, int ShaderBufferType, const std::string& Name, const TCHAR* FileName,
...
void CMaterial::SetTexture(int Index, int Register, int ShaderBufferType, const std::string& Name, const std::vector<const TCHAR*>& vecFileName, const std::string& PathName)
{
	if (Index < 0 || Index >= (int)m_vecTextureInfo.size())
		return;
...
void CMaterial::SetTextureFullPath(int Index, int Register,	int ShaderBufferType, const std::string& Name, const std::vector<const TCHAR*>& vecFullPath)
{
	if (Index < 0 || Index >= (int)m_vecTextureInfo.size())
		return;
...
void CMaterial::SetMaterial()
{
	...
	for (int i = 0; i < (int)ERenderStateType::End; ++i)
	{
		if (m_RenderState[i])
	...
	{
		m_vecTextureInfo[i]->Texture->SetShader(m_vecTextureInfo[i]->Register, m_vecTextureInfo[i]->ShaderBufferType, m_vecTextureInfo[i]->Index);
	}
}
