...
protected:
    ...
    CSharedPtr<CRenderState>            m_RenderState[(int)ERenderStateType::End];
...
public:
    ...
    // === Texture 추가 ===
    void AddTexture(int Register, int ShaderBufferType, const std::string& Name, class CTexture* Texture);
    void AddTexture(int Register, int ShaderBufferType, const std::string& Name, const TCHAR* FileName, const std::string& PathName = TEXTURE_PATH);
    ...
    void SetTexture(int Index, int Register, int ShaderBufferType, const std::string& Name, const TCHAR* FileName, const std::string& PathName = TEXTURE_PATH);
